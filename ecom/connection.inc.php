...
define('PRODUCT_IMAGE_SERVER_PATH',SERVER_PATH.'https://avestantechnologies.com/ecom/media/product/');
define('PRODUCT_IMAGE_SITE_PATH',SITE_PATH.'media/product/');

define('PRODUCT_MULTIPLE_IMAGE_SERVER_PATH',SERVER_PATH.'https://avestantechnologies.com/ecom/media/product_images/');
