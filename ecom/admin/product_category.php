                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="card" style="overflow: auto;">
                                <div class="card-body">
                                    <h6><i class="fa-solid fa-layer-group"></i> Categories</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                                        ...
                                        <form id="categoryForm" method="POST" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="categoryShortName"
                                                        name="category_short_name">
                                                    <span class="text-danger error" id="categoryShortNameError"></span>
                                                </div>
                                                <div class="form-group" style="display: none;" id="imageContainer">
                                                    <img src="" alt="categorytImage" width="50px" height="50px">
                                                </div>
                                                <div class="form-group">
                                                    <label for="categoryImage">Category Image:</label>
                                                    <input type="file" class="form-control" id="categoryImage"
                                                        name="category_image" accept="image/*">
                                                    <span class="text-danger error" id="categoryImageError"></span>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-info" name="addBtn" id="addBtn">Add
                                                    category</button>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="categoryTable" class="table display table-responsive-md"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td>
                                                    <label for="">Catgeory Image</label>
                                                </td>
                                                <td>
                                                    <label for="">Category Name</label>
                                                </td>
                                                <td>
                                                    <label for="">Category Short Name</label>
                                                </td>
                                                <td>
                            ...
                            <div class="card">
                                <div class="card-body" style="overflow: auto;">
                                    <button class="btn btn-danger font-weight-bold" type="button" name="deleteAllBtn"
                                        id="deleteAllBtn" disabled><i class="fa-solid fa-trash me-2"></i> Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
