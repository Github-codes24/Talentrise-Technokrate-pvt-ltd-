...
<body class="font-montserrat">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="card" style="overflow: auto;">
                                <div class="card-body">
                                    <h6><i class="fa-solid fa-list"></i> Specification</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <button type="button" class="btn btn-info my-2" data-toggle="modal"
                                ...
                                <i class="fa-solid fa-plus"></i> Add New Specification
                            </button>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="productName" name="product_name">
                                                        ...
                                                        <!-- Product names will be populated dynamically based on the selected subcategory -->
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger error" id="specializationNameError"></span>
                                                </div>
                                            </div>
    ...
    <script src="js/specification_list.js"></script>
