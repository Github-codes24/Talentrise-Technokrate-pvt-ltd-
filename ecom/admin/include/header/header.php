      ...
      <div class="page-header">
         ...
         <div class="right">
            <div class="input-icon xs-hide mr-4">
               ...
               <span class="input-icon-addon"><i class="fa-brands fa-searchengin"></i></span>
            </div>
            <div class="notification d-flex">
               ...
               <div class="dropdown d-flex">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                     <a class="dropdown-item" href="page-profile.html"><i class="dropdown-icon fa-solid fa-user"></i></i>
                        Profile</a>
                     <a class="dropdown-item" href="app-setting.php"><i class="dropdown-icon fa-solid fa-gear"></i>
                        Settings</a>
                     <a class="dropdown-item" href="javascript:void(0)"><span class="float-right"><span
                              class="badge badge-primary">6</span></span><i class="dropdown-icon fa-solid fa-envelope"></i>
                        Inbox</a>
                     <a class="dropdown-item" href="javascript:void(0)"><i class="dropdown-icon fa-solid fa-message"></i>
                        Message</a>
                     <div class="dropdown-divider"></div>
                     <a class="dropdown-item" href="javascript:void(0)"><i class="dropdown-icon fa-solid fa-circle-info"></i>
                        Need help?</a>
                     <a class="dropdown-item" href="logout.php"><i class="dropdown-icon fa-solid fa-right-from-bracket"></i> Sign out</a>
                  </div>
               </div>
            </div>
         </div>
