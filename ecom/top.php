...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-vB6f7Iq9V+04fqvzjB+gZGa9aoT9sC4fZV6cW8MvimtfFjmHL57h9Zo0rtBJUdx04jXYEL+uUlqAm2XuESvKrA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body>
  ...
  <header id="top-header" class="htc__header__area">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12">
                <div class="logo">
                    <a href="index.php"><img src="images/logo/4.png" alt="logo images" style="max-height: 60px; max-width: 200px;"></a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
				...
				<?php 
                    ...
                    <div class="header__account">
                        ...
                        <a href="my_order.php">Hi <?php echo $_SESSION['USER_NAME']?></a>
...
<nav id="htc__menu" class="htc__menu__area">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
