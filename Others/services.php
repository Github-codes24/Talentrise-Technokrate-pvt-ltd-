...
<!-- Mirrored from htmldemo.net/mitech/it-services.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 14:10:38 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_box text-center">
                        <h2 class="breadcrumb-title">Services</h2><br>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="section-title-wrap text-center">
                                <h3 class="heading">Preparing for your success, <br> we provide <span class="text-color-primary">  truly prominent solutions.</span></h3>
                            </div>
                            <!-- section-title-wrap Start -->
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/mitech-box-image-style-01-image-01-100x108.webp" alt="">
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading">Mobile App Development </h5>
                                                    <div class="text">We develop the important and working app for companies and businesses worldwide.
                                                        Because of this we are working easily in mobile also.
                                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/mitech-box-image-style-01-image-02-100x108.webp" alt="">
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading">Custom Software Development</h5>
                                                    <div class="text">We also develop the custom software for companies.It’s possible to simultaneously manage.                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                                        <a href="#">
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/mitech-box-image-style-01-image-03-100x108.webp" alt="">
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading">Software Outsourcing Services</h5>
                                                    <div class="text">we provide software outsourcing services.we develop the oustsourcing products.Sofware develop by outsource resources.
                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/mitech-box-image-style-01-image-04-100x108.webp" alt="">
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading">Software Product Development</h5>
                                                    <div class="text">Software product development helps create marketable commercial software for business users or individual consumers.
                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/mitech-box-image-style-01-image-05-100x108.webp" alt="">
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading">Web Development</h5>
                                                    <div class="text">We work on web development.Develop the various types of responsive and working sites. develop the Ecommerce sites, business sites etc... 
                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/mitech-box-image-style-01-image-06-100x108.webp" alt="">
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading">UI & UX Design Teaching</h5>
                                                    <div class="text">Teaching, creating and working on UI and UX designs for developing most resopnsive websites properly.Because of UI design the work is manage properly.
                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                ...
                                <div class="contact-list-item">
                                    <a href="" class="single-contact-list">
                                        <div class="content-wrap">
                                            ...
                                            <!--        <div class="text" style="font-size: 20px;">+91 8381009662</div>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                        </div>
                                    </a>
                                    <a href="info@avestantechnologies.com" class="single-contact-list">
                                        <div class="content-wrap">
                                            <div class="content">
                                                <div class="icon">
                                                ...
                                                <div class="main-content">
                                                    ...
                                                    <div class="text" style="font-size: 20px;">info@avestantechnologies.com</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    <a href="https://join.skype.com/wq7iXxcjbQTf" class="single-contact-list">
                                            <div class="content-wrap">
                                                <div class="content">
                                                    <div class="icon">
                                                        <img src="assets/img/skype.jfif" style="border-radius:50%;"/>
                                                    </div>
                                                    <div class="main-content">
    ...
    <div class="demo-option-container">
        ...
        <div class="demo-option-wrapper">
            <div class="demo-panel-header">
                <div class="title">
                    <h6 class="heading mt-30">Avestan Technologies</h6>
                </div>
            ...
            <div class="demo-quick-option-list">
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-appointment.php" aria-label="Appointment">
                    <img class="img-fluid" src="assets/images/demo-images/home-01.webp" alt="Images">
                </a>
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-infotechno.php" aria-label="Infotechno">
                    <img class="img-fluid" src="assets/images/demo-images/home-02.webp" alt="Images">
                </a>
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-processing.php" aria-label="Processing">
                    <img class="img-fluid" src="assets/images/demo-images/home-03.webp" alt="Images">
                </a>
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-services.php" aria-label="Services">
                    <img class="img-fluid" src="assets/images/demo-images/home-04.webp" alt="Images">
                </a>
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-resolutions.php" aria-label="Resolutions">
                    <img class="img-fluid" src="assets/images/demo-images/home-05.webp" alt="Images">
                </a>
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-cybersecurity.php" aria-label="Cybersecurity">
                    <img class="img-fluid" src="assets/images/demo-images/home-06.webp" alt="Images">
                </a>
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-modern-it-company.php" aria-label="Modern IT Company">
                    <img class="img-fluid" src="assets/images/demo-images/modern-it-company.webp" alt="Images">
                </a>
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-machine-learning.php" aria-label="Machine Learning">
                    <img class="img-fluid" src="assets/images/demo-images/machine-learning.webp" alt="Images">
                </a>
                <a class="link hint--bounce hint--black hint--top hint--dark" href="index-software-innovation.php" aria-label="Software Innovation">
...
<!-- Mirrored from htmldemo.net/mitech/it-services.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 14:10:39 GMT -->
</html>